...
<div class="wrapper-boxed">
    ...
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
       		<div class="col-md-6"> <h3>Payment notify</h3></div>
        </div>
      </div>
    </div>
  </section>
...
<section class="sec-bpadding-2">
  ...
  <div class="row">  
	...
	<section class="">	  
		<h4 style="color: #9c0101;">Order Number <?php echo $getorder2->OrderNumber?></h4>  
	...
	<div class="row">
	  ...
	  <h4><span style="color: #fff;  background-color: #ecae3d; padding: 10px;"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Product Data</span></h4>
	 <table class="sp-cart">
			  <tr>
        ...
        $pricesum = $order_detail->amount*$order_detail->price;
			 ...
			 <tr>
				...
				<td class="pro-des" align="left"a><?php echo number_format($pricesum,2)?> Baht</td>
			 </tr>
                         <?php }?>
			 <tr>
				<td class="pro-title"><h6>Total Product</h6></td>
				<td class="pro-des" align="left"a><?php echo number_format($sumcart,2)?> Baht</td>
			 </tr>   
			 <tr>
				<td class="pro-title"><h6>Delivery Cost</h6></td>
				<td class="pro-des" align="left"a><?php echo number_format($getorder2->Delivery_Cost,2)?> Baht</td>
			 </tr>   
			 <tr>
				<td class="pro-title"><h6>Total Price</h6></td>
				<td class="pro-des" align="left"a><?php echo number_format($getorder2->total_price,2)?> Baht</td>
			 </tr>   
		  </table>
            <?php if($getorder2->checkdata=='1'){?>
                                        <p style="color: #9c0101;font-size: 16px">*Registered Mail 60 Baht THB next piece of +10.</p>
                                        <?php }else{?>
                                        <p style="color: #9c0101;font-size: 16px" >*Parcel EMS 80 baht baht next piece of +10.</p>
                                        <?php }?>
	  </div>
        ...
        $amphures_name = $amphuresbyid->name_th;
                      ...
                      ?>
	  <div class="col-md-6">	 
		  <h4><span style="color: #fff;  background-color: #ecae3d; padding: 10px;"><i class="fa fa-user"></i>&nbsp;&nbsp;Customer Detail</span></h4>
		  <table class="sp-cart">
			  <tr>
				<th style="width:40%;"></th>
				<th style="width:60%;"></th>
			 ...
			 <tr>
				<td class="pro-title"><h6>Name-Surname</h6></td>
			 ...
			 <tr>
				<td class="pro-title"><h6>E-mail</h6></td>
				<td class="pro-des" align="left"a><?php echo $getorder2->customer_email?></td>
			 </tr>  
			 <tr>
				<td class="pro-title"><h6>Address</h6></td>
            ...
            <br>
            <?php $getpaymentbyorderid = $this->Product_model->getpaymentbyorderid($order_id);
     foreach ($getpaymentbyorderid->result() AS $payment){}?>
            <div class="row">
                <div class="col-md-6" style="padding-left: 30px">	 
		  <h4><span style="color: #fff;  background-color: #ecae3d; padding: 10px;"><i class="fa fa-user"></i>&nbsp;&nbsp;Payment Detail</span></h4>
		  <table class="sp-cart">
			  <tr>
				<th style="width:40%;"></th>
				<th style="width:60%;"></th>
			 ...
			 <tr>
				<td class="pro-title"><h6>Transfer Date</h6></td>
				<td class="pro-des" align="left"a><?php echo $this->Product_model->GetthaiDate($payment->TransferDate)?> <?php echo $payment->Time?></td>
			 </tr>  
			  <tr>
				<td class="pro-title"><h6>Transfer Amount</h6></td>
				<td class="pro-des" align="left"a><?php echo number_format($payment->TransferAmount,2)?></td>
			 <tr>
				<td class="pro-title"><h6>Bank Transfers Money</h6></td>
                                <td class="pro-des" align="left"a><?php if($payment->Bank=='1'){?>Kasikorn Bank Account number 007-1-57859-3<?php }?></td>
			 </tr>  
			 <tr>
				<td class="pro-title"><h6>Additional Text</h6></td>
				<td class="pro-des" align="left"a><?php echo $payment->AdditionalText?></td>
			 </tr> 
		  </table>	
	  </div>
            <div class="col-md-6">	 
		  <h4><span style="color: #fff;  background-color: #ecae3d; padding: 10px;"><i class="fa fa-user"></i>&nbsp;&nbsp;Proof Of Payment</span></h4>
		 <div style="background-color: #e2e2e2; margin-right: 20px; padding: 10px;">
			 ...
			 <tr>
				<td class="pro-title"><img src="<?php echo base_url('uploadfile/'.$payment->file)?>" class="img-responsive"></td>
