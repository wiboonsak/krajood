...
<div class="wrapper-boxed">
    ...
    <div class="pagenation-holder">
      <div class="container">
        <div class="row">
       		<div class="col-md-6"> <h3>Reservation Request Product</h3></div>
        </div>
      </div>
    </div>
  </section>
		 ...
		 <div style="background-color: #e2e2e2; margin-right: 20px; padding: 10px;">
			 ...
			 <tr>
				<td class="pro-title" align="center"><img src="<?php echo base_url('HTML/images/lp-ddbank-stepbank-kbank.png')?>" class="img-responsive"></td>
                                <td class="pro-des" ><p style="color: #9c0101">You can pay by money transfer Kasikorn Bank.<br>
					Account number 007-1-57859-3<br>
                                    Account name Chalani Boonchuchay</p></td>
			 </tr>  
		  </table>	
