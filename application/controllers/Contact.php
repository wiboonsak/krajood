...
<body>
  ...
  <tbody>
    <tr>
      <td align="center" bgcolor="#ecae3d" style="color:#FFFFFF;"><h2>Contact from Website</h2>www.kra-joodthailand.com<br><br></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td align="left" valign="top" style="font-size: 11pt; color: #666666; line-height: 25px; padding-left: 25px;">
		  <p>A customer contacted you from the www.kra-joodthailand.com website. The content below:</p><br></td>
    </tr>
    <tr>
      <td>        
...
';		
		...
		$this->email->from($from_email, 'kra-joodthailand'); 
        $this->email->to($to_email);
        $this->email->subject('จดหมายติดต่อจากคุณ '.$inputName .'( '.$from_email.' )'); 
        $this->email->message($email_body); 
        //Send mail 
        if($this->email->send()){ 
            echo " <script>alert('Your message has been send.');"
            . "location.replace('http://kra-joodthailand.com/DEMO/Welcome/contact')"
                    . "</script>";
